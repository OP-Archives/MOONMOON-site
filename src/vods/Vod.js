...
export default function Vod(props) {
  ...
  const DEFAULT_THUMBNAIL = vod.youtube.length > 0 ? vod.youtube.thumbnail_url[0] : vod.games.length > 0 ? vod.games[0].thumbnail_url : vod.thumbnail_url ? vod.thumbnail_url : sadge;
